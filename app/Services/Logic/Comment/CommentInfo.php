...
class CommentInfo extends LogicService
{
    ...
    protected function handleComment(CommentModel $comment, UserModel $user): array
    {
    ...
    protected function handleToUserInfo(int $userId): ?array
    {
    ...
    protected function handleMeInfo(CommentModel $comment, UserModel $user): array
    {
        $me = [
            'logged' => 0,
            'liked' => 0,

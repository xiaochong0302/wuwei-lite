...
trait ListTrait
{
    ...
    public function handleComments(RepositoryInterface $pager): RepositoryInterface
    {
        ...
        $comments = $pager->getItems()->toArray();
        ...
        foreach ($comments as $comment) {
            ...
            $owner = $users[$comment['owner_id']] ?? null;
            $toUser = $users[$comment['to_user_id']] ?? null;
    ...
    protected function getMeMappings(array $comments): array
    {

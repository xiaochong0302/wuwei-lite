                ...
                <form class="layui-form kg-form" method="POST" action="{{ update_user_url }}">
                    ...
                    {% if auth_user.admin_role == 1 %}
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="admin_role" value="0" title="N/A" {% if user.admin_role == 0 %}checked="checked"{% endif %}>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="edu_role" value="1" title="{{ locale._('edu_role_student') }}" {% if user.edu_role == 1 %}checked="checked"{% endif %}>
                            <input type="radio" name="edu_role" value="2" title="{{ locale._('edu_role_teacher') }}" {% if user.edu_role == 2 %}checked="checked"{% endif %}>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ locale._('vip') }}</label>
                        <div class="layui-input-block">
                            <input type="radio" name="vip" value="1" title="{{ locale._('yes') }}" lay-filter="vip" {% if user.vip == 1 %}checked="checked"{% endif %}>
                            <input type="radio" name="vip" value="0" title="{{ locale._('no') }}" lay-filter="vip" {% if user.vip == 0 %}checked="checked"{% endif %}>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="locked" value="1" title="{{ locale._('yes') }}" lay-filter="locked" {% if user.locked == 1 %}checked="checked"{% endif %}>
                            <input type="radio" name="locked" value="0" title="{{ locale._('no') }}" lay-filter="locked" {% if user.locked == 0 %}checked="checked"{% endif %}>
                        </div>
                    </div>
            ...
            <div class="layui-tab-item">
                <form class="layui-form kg-form" method="POST" action="{{ update_user_url }}">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input class="layui-input" type="text" name="email" value="{{ account.email }}" lay-verify="email">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ locale._('password') }}</label>
                        <div class="layui-input-block">
                            <input class="layui-input" type="text" name="password" placeholder="{{ locale._('leave_pwd_blank_tips') }}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"></label>

...
{% block content %}
    ...
    <form class="layui-form kg-form" method="GET" action="{{ url({'for':'admin.review.list'}) }}">
        <fieldset class="layui-elem-field layui-field-title">
            <legend>{{ locale._('search_review') }}</legend>
        </fieldset>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ locale._('review_author') }}</label>
            <div class="layui-input-block">
                <input class="layui-input" type="text" name="owner_id" placeholder="{{ locale._('account_search_tips') }}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">{{ locale._('course_id') }}</label>
            <div class="layui-input-block">
                <input class="layui-input" type="text" name="course_id" placeholder="{{ locale._('exact_match_tips') }}">
            </div>
        </div>
